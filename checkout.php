        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread"> Chechout </h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-8 ftco-animate">
						<form method="POST"  action="confirm_order.php" class="billing-form ftco-bg-dark p-3 p-md-5">
		            ...
		            <div class="col-md-12">
		            	<div class="form-group">
		                  ...
		                  <select name="country" id="" class="form-control">
		                  	<option  style="color:black;" value="cairo">cairo</option>
		                    <option  style="color:black;" value="Alex"> Alex</option>
                        <option  style="color:black;" value="tanta">Tanta</option>
                        <option  style="color:black;" value="mansoura">Mansoura </option>
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
										<div class="radio">
                    <button name="confirm" class="btn btn-primary py-3 px-4">Confirm the Order</button>
										</div>
									</div>
                </div>
	            </div>
